...
NAME = 'model-house-pricing'
DESCRIPTION = "Empaquetamiento para modelo de predicción de precios en WA, USA"
URL = "https://github.com/carlossil05/G2-Proyecto-DSA"
EMAIL = "ca.silva998@uniandes.edu.co"
AUTHOR = "carlosasilvaa"
